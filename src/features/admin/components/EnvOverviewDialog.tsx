...
export function EnvOverviewDialog({ open, onOpenChange }: { open: boolean, onOpenChange: (open: boolean) => void }) {
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-none sm:max-w-none w-screen h-[100dvh] p-0 m-0 !rounded-none border-none flex flex-col bg-background/95 backdrop-blur-3xl overflow-hidden shadow-none z-50">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <DialogTitle className="text-base font-black text-foreground leading-tight flex items-center gap-2">
                                <span>Vista Ambientes</span>
                            </DialogTitle>
                            <DialogDescription className="text-[11px] text-muted-foreground mt-0">
                                Sección en construcción para la gestión general de ambientes.
                            </DialogDescription>
                        </div>
                    </div>
                ...
                <div className="flex-1 flex flex-col items-center justify-center text-muted-foreground p-8">
                    ...
                    <h2 className="text-2xl font-bold mb-2">Vista Ambientes</h2>
                    <p className="text-center max-w-md">Esta sección está actualmente en construcción. Aquí podrás gestionar y visualizar toda la disponibilidad y cruces de uso de los ambientes en una vista general.</p>
                </div>
            </DialogContent>
        </Dialog>
    );
