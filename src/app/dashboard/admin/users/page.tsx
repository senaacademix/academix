...
import { getGroupsAction } from "@/features/admin/actions/academicActions";
...
export default async function AdminUsersPage() {
    ...
    return (
        <div className="p-8">
            <UserManagement initialUsers={users} totalCount={total} initialGroupId={defaultGroupId} initialGroups={groups.map(g => ({id: g.id, name: g.name}))} />
        </div>
    );
}
